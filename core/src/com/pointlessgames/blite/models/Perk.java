...
public class Perk {
	...
	public static void drawPerk(FilledShapeRenderer sR, SpriteBatch batch, BitmapFont font, float x, float y, float r, int type) {
	...
	private static void drawFreezePerk(FilledShapeRenderer sR, SpriteBatch batch, BitmapFont font, float x, float y, float r) {
		sR.begin(ShapeRenderer.ShapeType.Filled);
		sR.setColor(Settings.colorText);
		y += r / 15;
		sR.rect(x + r / 4 - r / 20, y - r / 3, r / 10, r / 1.2f);
		Utils.reversedArrow(sR, x - r / 4, y - r / 3 + r / 2.4f, r / 4.8f, 0);
		Utils.reversedArrow(sR, x - r / 4, y - r / 3 + r / 2.4f, r / 4.8f, MathUtils.degRad * 60);
		Utils.reversedArrow(sR, x - r / 4, y - r / 3 + r / 2.4f, r / 4.8f, MathUtils.degRad * -60);
		y -= r / 15;
		batch.begin();
	...
	private static void drawSpeedPerk(FilledShapeRenderer sR, SpriteBatch batch, BitmapFont font, float x, float y, float r) {
		sR.begin(ShapeRenderer.ShapeType.Filled);
		sR.setColor(Settings.colorText);
		y += r / 15;
	...
	private static void drawSizePerk(FilledShapeRenderer sR, SpriteBatch batch, BitmapFont font, float x, float y, float r) {
		sR.begin(ShapeRenderer.ShapeType.Filled);
		sR.setColor(Settings.colorText);
		y += r / 15;
		sR.rect(x + r / 4 - r / 20, y - r / 3, r / 10, r / 1.2f);
	...
	public static void savePerks(Preferences preferences) {
		for(int i = 0; i < level.length; i++)
			preferences.putInteger(Settings.LEVEL + i, level[i]);
		preferences.flush();
	}

	public static void loadPerks(Preferences preferences) {
		for(int i = 0; i < level.length; i++)
